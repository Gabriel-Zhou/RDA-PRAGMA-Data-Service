...
import landingpage.lm.utils.MD5Utils;
...
public class ValidationController {
	...
	public MessageResponse validation(@RequestParam(value = "vmPID", required = true) String vm_pid,
		...
		String file_url = "http://"+vm_validation.getManifest().getImageManifest().getHostname() + "/services/projections/"
				+ proj_origin.getInternalID() + "/tiff";
